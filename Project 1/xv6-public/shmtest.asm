...
int main() {
  ...
  16:	e8 40 03 00 00       	call   35b <shm_alloc>
  ...
  3e:	51                   	push   %ecx
  3f:	51                   	push   %ecx
  40:	68 48 07 00 00       	push   $0x748
  45:	6a 01                	push   $0x1
  47:	e8 d4 03 00 00       	call   420 <printf>
  4c:	83 c4 10             	add    $0x10,%esp
  4f:	eb e3                	jmp    34 <main+0x34>
  51:	66 90                	xchg   %ax,%ax
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 94 07 00 00       	mov    $0x794,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 732:	00 00 00 
    if(p->s.size >= nunits){
