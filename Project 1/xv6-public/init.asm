...
int main(void)
{
  ...
  11:	6a 02                	push   $0x2
  13:	68 c8 07 00 00       	push   $0x7c8
  18:	e8 56 03 00 00       	call   373 <open>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	0f 88 90 00 00 00    	js     b8 <main+0xb8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2b:	6a 00                	push   $0x0
  2d:	e8 79 03 00 00       	call   3ab <dup>
  dup(0);  // stderr
  32:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  39:	e8 6d 03 00 00       	call   3ab <dup>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	eb 10                	jmp    53 <main+0x53>
  ...
  51:	79 52                	jns    a5 <main+0xa5>
    printf(1, "init: starting sh\n");
  53:	83 ec 08             	sub    $0x8,%esp
  56:	68 d0 07 00 00       	push   $0x7d0
  5b:	6a 01                	push   $0x1
  5d:	e8 3e 04 00 00       	call   4a0 <printf>
    pid = fork();
  62:	e8 c4 02 00 00       	call   32b <fork>
    if(pid < 0){
  67:	83 c4 10             	add    $0x10,%esp
  6a:	85 c0                	test   %eax,%eax
  6c:	79 da                	jns    48 <main+0x48>
      printf(1, "init: fork failed\n");
  6e:	50                   	push   %eax
  6f:	50                   	push   %eax
  70:	68 e3 07 00 00       	push   $0x7e3
  75:	6a 01                	push   $0x1
  77:	e8 24 04 00 00       	call   4a0 <printf>
      exit();  // Will exit if fork fails
  7c:	e8 b2 02 00 00       	call   333 <exit>
      exec("sh", argv);  // Execute the shell
  81:	52                   	push   %edx
  82:	52                   	push   %edx
  83:	68 40 0b 00 00       	push   $0xb40
  88:	68 f6 07 00 00       	push   $0x7f6
  8d:	e8 d9 02 00 00       	call   36b <exec>
      printf(1, "init: exec sh failed\n");
  92:	59                   	pop    %ecx
  93:	58                   	pop    %eax
  94:	68 f9 07 00 00       	push   $0x7f9
  99:	6a 01                	push   $0x1
  ...
  a5:	50                   	push   %eax
  a6:	50                   	push   %eax
  a7:	68 10 08 00 00       	push   $0x810
  ac:	6a 01                	push   $0x1
  ae:	e8 ed 03 00 00       	call   4a0 <printf>
  b3:	83 c4 10             	add    $0x10,%esp
  b6:	eb 9b                	jmp    53 <main+0x53>
    mknod("console", 1, 1);
  b8:	50                   	push   %eax
  b9:	6a 01                	push   $0x1
  bb:	6a 01                	push   $0x1
  bd:	68 c8 07 00 00       	push   $0x7c8
  c2:	e8 b4 02 00 00       	call   37b <mknod>
    open("console", O_RDWR);
  c7:	58                   	pop    %eax
  c8:	5a                   	pop    %edx
  c9:	6a 02                	push   $0x2
  cb:	68 c8 07 00 00       	push   $0x7c8
  d0:	e8 9e 02 00 00       	call   373 <open>
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	e9 4b ff ff ff       	jmp    28 <main+0x28>
  dd:	66 90                	xchg   %ax,%ax
  df:	90                   	nop
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 40 08 00 00 	jmp    *0x840(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 36 08 00 00       	mov    $0x836,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 48 0b 00 00    	mov    %edx,0xb48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 48 0b 00 00    	mov    0xb48,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 48 0b 00 00 4c 	movl   $0xb4c,0xb48
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 4c 0b 00 00       	mov    $0xb4c,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 7b2:	00 00 00 
    if(p->s.size >= nunits){
